package net.fragre.testmod.screen;
...
public class DistillerMenu extends AbstractContainerMenu {
    ...
    public DistillerMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
        this(id, inv, inv.player.level.getBlockEntity(extraData.readBlockPos()), new SimpleContainerData(2));
    }

    public DistillerMenu(int id, Inventory inv, BlockEntity entity, ContainerData data) {
        super(ModMenuTypes.DISTILLER_MENU.get(), id);
